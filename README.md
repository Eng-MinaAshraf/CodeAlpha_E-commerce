...
## 🌟 Overview
This project was developed as a highly scalable graduation project. It operates on a Client-Server architecture, serving an SPA-like frontend powered by ES modules and a RESTful backend API. 

## ✨ Features
- **Authentication & Authorization**: Secure signup, login, and user profile management using Supabase Auth.
...
│   ├── js/                 # Client-side scripts (api.js, utils.js, cart.js)
